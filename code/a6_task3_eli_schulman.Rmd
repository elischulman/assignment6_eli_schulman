...
ggplot(lizards, aes(x = spp, y = total_length)) +
  ...
  labs(title = "Female Colorado Checkered vs Desert Grassland Lizards",
       x = "Species",
       y = "Length (mm)",
       caption = str_wrap("Figure 1: Shows the distribution in lengths between females in the two lizard species sampled at the Jornada Basin. The mean length of each species is represented by the golden diamond. "),
       color = "Species") +
